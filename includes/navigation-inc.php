...
<!-- === Navigation === -->
  <nav class="navbar navbar-expand-lg navbar-change" id="navbar">
		<div class="logo"><a href="/" title="Strona główna Rbcode.pl"><img class="img-fluid" src="images/logo-małe.png" alt="Rbcode logo" title="Logo Rbcode.pl"></a></div>
		<div class="company-name font-kanit pl-3"  id="company-name"><a href="/" title="Strona główna Rbcode.pl" ><p>Rbcode.pl</p></a></div>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav" id="nav-item-menu" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
          ...
          <li class="nav-item" itemprop="name" >
            <a itemprop="url" class="nav-link" href="realizacje-stron-internetowych" title="Realizacje stron internetowych">REALIZACJE</a>
          </li>
          <li class="nav-item" >
            ...
            <a class="nav-link-phone d-flex justify-content-center align-items-center" href="tel:+48578356352" title="Skontaktuj się znami pod numerem telefonu 578356352"><i class="fas fa-phone pr-2"></i>578 356 352</a>
		            ...
		            <a itemprop="url" href="koszt-strony-internetowej" class="btn btn-wycena" role="button" aria-pressed="true" title="Skorzystaj z bezpłatnej wyceny projektu">WYCEŃ PROJEKT</a>
